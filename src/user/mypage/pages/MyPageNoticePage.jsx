...
const ExpandMoreIcon = () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M16 10L12 14L8 10" stroke="#888" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
);

const ExpandLessIcon = () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M8 14L12 10L16 14" stroke="#888" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
);
...
const dummyNotices = [
    {
        id: 1,
        title: '짐마당 신규 업데이트 안내 (v1.1.0)',
        date: '2025.08.20',
        content: `
            안녕하세요, 짐마당 팀입니다. 
            짐마당 앱의 새로운 업데이트가 적용되었습니다. 주요 변경사항은 다음과 같습니다.
                    ...
                    >
                        <div className="notice-summary" onClick={() => handleNoticeClick(notice.id)}>
                            ...
                            <span className="notice-arrow">
                                {openNoticeId === notice.id ? <ExpandLessIcon /> : <ExpandMoreIcon />}
                            </span>
                        </div>
